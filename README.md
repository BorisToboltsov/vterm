...
- 🔎 **Поиск по всему буферу терминала** — не только по видимому экрану, а по всему
  ...
  подсвечиваются цветами активной темы.
- ⚙️ **Раздел настроек «Логи и текст»** с **мастер-переключателем**: один чекбокс
  ...
  (плюс отдельные тумблеры по фичам).
...
| Терминал | **xterm.js 6** + addon-fit/webgl/search | Веб-терминал с поддержкой ANSI, поиск по буферу |
